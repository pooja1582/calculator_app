                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        MYButton(title:'8',onPress: (){userInput += '8';
                        setState((){

                        });},),
                        MYButton(title:'0',onPress: (){userInput += '0';
                        setState((){

                        });},),
                        MYButton(title:'x',color: Color(0xffffa00a),onPress: (){userInput += 'x';
                        setState((){
                    ...
                    Row(
                      children: [
                        ...
                        MYButton(title:'+',color: Color(0xffffa00a),onPress: (){userInput += '+';
                        setState((){
